...
Here is another fun way to represent the counts of unigrams!
...
For this analysis we will take advantage of customizing the stopwords lexicon. Professor names appear a lot, so we remove that.
